...
namespace FillingLevelApp.Views
{
    ...
    /// </summary>
    public sealed partial class ViewSensorPage : Page
    {
      //  private WeatherStationLib.WeatherStationEnvironment m_Environment;

     //   private WeatherStationLib.WeatherStationListeners m_WeatherStationListeners;
        private StationLib.StationSensors m_SensorValues;
        public ViewSensorPage()
        {
